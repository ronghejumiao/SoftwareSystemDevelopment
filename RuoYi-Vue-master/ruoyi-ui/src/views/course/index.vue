<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程编号，唯一标识" prop="courseCode">
        <el-input
          v-model="queryParams.courseCode"
          placeholder="请输入课程编号，唯一标识"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      ...
      <el-form-item label="授课教师ID，关联sys_user表" prop="teacherId">
        <el-input
          v-model="queryParams.teacherId"
          placeholder="请输入授课教师ID，关联sys_user表"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程ID，主键，自增" align="center" prop="courseId" />
      <el-table-column label="课程名称" align="center" prop="courseName" />
      <el-table-column label="课程编号，唯一标识" align="center" prop="courseCode" />
      <el-table-column label="课程分类" align="center" prop="courseCategory" />
      <el-table-column label="授课教师ID，关联sys_user表" align="center" prop="teacherId" />
      ...
      <el-table-column label="课程状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.char" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程编号，唯一标识" prop="courseCode">
          <el-input v-model="form.courseCode" placeholder="请输入课程编号，唯一标识" />
        </el-form-item>
        <el-form-item label="课程分类" prop="courseCategory">
          <el-input v-model="form.courseCategory" placeholder="请输入课程分类" />
        </el-form-item>
        <el-form-item label="授课教师ID，关联sys_user表" prop="teacherId">
          <el-input v-model="form.teacherId" placeholder="请输入授课教师ID，关联sys_user表" />
        </el-form-item>
        <el-form-item label="课程学分" prop="credit">
