<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="试卷库ID，关联course_paper_library表" prop="libraryId">
        <el-input
          ...
          placeholder="请输入试卷库ID，关联course_paper_library表"
          clearable
    ...
    <el-table v-loading="loading" :data="paperList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="试卷ID，主键，自增" align="center" prop="paperId" />
      <el-table-column label="试卷库ID，关联course_paper_library表" align="center" prop="libraryId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="试卷库ID，关联course_paper_library表" prop="libraryId">
          <el-input v-model="form.libraryId" placeholder="请输入试卷库ID，关联course_paper_library表" />
        </el-form-item>
        <el-form-item label="试卷名称" prop="paperName">
