<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="homeworkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="作业名称" align="center" prop="homeworkName" />
      <el-table-column label="作业描述" align="center" prop="homeworkDesc" />
      <el-table-column label="作业附件路径，json数组字符串" align="center" prop="filePaths" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="作业描述" prop="homeworkDesc">
          <el-input v-model="form.homeworkDesc" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="作业附件路径，json数组字符串" prop="filePaths">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课程作业编号为"' + homeworkIds + '"的数据项？').then(function() {
