  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="试卷库描述" prop="libraryDesc">
          <el-input v-model="form.libraryDesc" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.reset()
      this.open = true
      this.title = "添加课程试卷库，一个课程对应一个试卷库"
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      this.reset()
      ...
      getLibrary(libraryId).then(response => {
        ...
        this.open = true
        this.title = "修改课程试卷库，一个课程对应一个试卷库"
      })
    },
    /** 提交按钮 */
    submitForm() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除课程试卷库，一个课程对应一个试卷库编号为"' + libraryIds + '"的数据项？').then(function() {
