        ...
        <el-table-column prop="dueDate" label="截止时间" />
          ...
          <template #default="scope">
            <el-button type="primary" size="small" @click="viewHomeworkDetail(scope.row)">查看详情</el-button>
              <el-button type="danger" size="small" @click="deleteHomework(scope.row)" v-hasRole="['admin','teacher']">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
      ...
      <el-card class="homework-section">
        ...
        <el-table :data="filteredGradeList" style="width:100%;" size="small">
          ...
          <el-table-column label="操作" width="120">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="openGradeDialog(scope.row)" v-hasRole="['admin','teacher']">查看详情</el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-card>
