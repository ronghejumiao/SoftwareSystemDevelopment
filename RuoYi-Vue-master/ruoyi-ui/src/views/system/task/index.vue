  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="提交方式" prop="submitMethod">
        <el-input
          v-model="queryParams.submitMethod"
          placeholder="请输入提交方式"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="taskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务ID，主键，自增" align="center" prop="taskId" />
      ...
      <el-table-column label="提交方式" align="center" prop="submitMethod" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="提交方式" prop="submitMethod">
          <el-input v-model="form.submitMethod" placeholder="请输入提交方式" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学习任务，存储课程的学习任务信息编号为"' + taskIds + '"的数据项？').then(function() {
